...
class StartMenu:
    def __init__(self):
        ...
        # background
        self.bg = pygame.transform.scale(pygame.image.load(os.path.join("images", "map_List.png")), (WIN_WIDTH, WIN_HEIGHT))
        # button
        ...
        # music and sound
        self.sound = pygame.mixer.Sound("./sound/background_01.mp3")
        self.sound_start = pygame.mixer.Sound("./sound/menu.wav")

    def play_music(self):
        self.sound_start.set_volume(0.1)
    ...
    def menu_run(self):
        ...
        pygame.display.set_caption("The Last Pure Land")
        self.play_music()
        while run:
            clock.tick(FPS)
...
class Buttons:
    ...
    def draw_frame(self, win):
        if self.frame is not None:
            pygame.draw.rect(win, (176, 224, 230), self.frame, 10)
