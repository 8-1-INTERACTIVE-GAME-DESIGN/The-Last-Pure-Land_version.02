...
class StartMenu:
    def __init__(self):
        ...
        # background
        self.bg = pygame.transform.scale(pygame.image.load(os.path.join("images", "BG_01.png")), (WIN_WIDTH, WIN_HEIGHT))
        # button
        ...
        # music and sound
        self.sound = pygame.mixer.Sound("sound/background_01.wav")
    ...
    def menu_run(self):
        ...
        pygame.display.set_caption("The_Last_Pure_Land")
        self.play_music()
        while run:
            clock.tick(FPS)
